"""
Web-based App for the Streamlit-News Connector.
"""
...
from st_news_connector.connection import NewsAPIConnection
...
def sidebar():
    ...
    st.sidebar.header("💡 Streamlit-News-Connector")
...
def main():
    ...
    """
    st.set_page_config(
        page_title="Streamlit-News App",
        page_icon="📰",
        initial_sidebar_state="expanded",
        menu_items={"About": "Built by CoderDojo"},
    )

    conn_newsapi = st.connection(
        "News", type=NewsAPIConnection)
